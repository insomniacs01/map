...
NAS_RUN_ROOT="${NAS_RUN_ROOT:-${REPO_ROOT}/experiments/long_runs/$(date +%Y%m%d_%H%M%S)_pinhole_pose_depth_scale_superstrong}"
LOCAL_ROOT="${LOCAL_ROOT:-${REPO_ROOT}/experiments/local_runs/pinhole_pose_depth_scale_superstrong}"
...
MAX_IMGS_PER_GPU="${MAX_IMGS_PER_GPU:-56}"
...
LR="${LR:-5e-5}"
MIN_LR="${MIN_LR:-5e-6}"
LOSS_NAME="${LOSS_NAME:-opv2v_vggt_pose_scale_loss_super_strong_pose}"
PRETRAINED_CKPT="${PRETRAINED_CKPT:-${REPO_ROOT}/experiments/long_runs/20260129_pinhole_pose_depth_scale_strong_a800_8g_v2/pinhole_pose_depth_scale/checkpoint-best.pth}"
